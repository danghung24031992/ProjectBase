...
internal struct ColorName {
  ...
  internal static let primaryColor = ColorName(rgbaValue: 0x222526ff)
  /// <span style="display:block;width:3em;height:2em;border:1px solid black;background:#000000"></span>
  /// Alpha: 0% <br/> (0x00000000)
  internal static let black = ColorName(rgbaValue: 0x00000000)
  /// <span style="display:block;width:3em;height:2em;border:1px solid black;background:#00000f"></span>
  /// Alpha: 100% <br/> (0x00000fff)
  internal static let white = ColorName(rgbaValue: 0x00000fff)
}
