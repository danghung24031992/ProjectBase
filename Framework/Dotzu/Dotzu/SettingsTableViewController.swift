...
class SettingsTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        imageViewLogo.tintColor = DotzuColor.mainGreen

        switchDisplayInfoFile.onTintColor = DotzuColor.mainGreen
        switchOverridePrint.onTintColor = DotzuColor.mainGreen
        switchResetLogs.onTintColor = DotzuColor.mainGreen
        switchDisplayDate.onTintColor = DotzuColor.mainGreen
        switchNetworkEnable.onTintColor = DotzuColor.mainGreen
